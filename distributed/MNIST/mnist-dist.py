...
class MNISTDataLoader(data.DataLoader):
    ...
    def __init__(self, data_root, batch_size, train=True):
        transform = transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize((0.1307,), (0.3081,)),
        ])

        dataset = datasets.MNIST(data_root, train=train, transform=transform, download=True)
        sampler = None
...
def run(args):
    ...
    train_loader = MNISTDataLoader(args.data_root, args.batch_size, train=True)
    test_loader = MNISTDataLoader(args.data_root, args.batch_size, train=False)
