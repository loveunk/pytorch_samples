...
# get the api_key from https://www.comet.ml/loveunk/quickstart
experiment = Experiment(api_key="",
                        project_name="pytorch_mnist",
                        workspace="loveunk")
...
def test(args, model, device, test_loader, epoch):
    ...
    experiment.log_metric("Accuracy_test", accuracy, step=epoch)
...
def main():
    ...
    if args.save_model:
        ...
        experiment.log_model("PyTorch mnist_cnn", "mnist_cnn.pt", copy_to_tmp=False)
